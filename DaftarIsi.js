...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Pencarian Cepat (CTRL+F)';
   var tocTool1 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   tocTable += '<centar>' + tocHead1 + '</center>';
   tocTable += '</td>';
   tocTable += '</tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<div class="ijo"><center>Menampilkan sebanyak ' + postTitle.length + ' buku</center></div>'; }
   else {
